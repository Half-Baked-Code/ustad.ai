...
// const StudyMaterial = () => {
//   const [studyMaterialTab, setStudyMaterialTab] = useState('FAQs');
...
//     <div className="description">Find answers to common questions</div>
//   </div>
//   <div className="study-material-card">
//     <div className="icon">📑</div>
//     <div className="text">Briefs</div>
//     <div className="description">Summarized course content</div>
//   </div>
//   <div className="study-material-card">
//     <div className="icon">📘</div>
//     <div className="text">Study Guides</div>
//     <div className="description">In-depth study materials</div>
//   </div>
//   <div className="study-material-card">
//     <div className="icon">🧠</div>
//     <div className="text">Mind Maps</div>
//     <div className="description">Visualize complex topics</div>
//   </div>
//   <div className="study-material-card">
//     <div className="icon">📝</div>
//     <div className="text">Self-Notes</div>
//     <div className="description">Personal notes and reflections</div>
//   </div>
// </div>
...
const StudyMaterial = ({ selectedDocs }) => {
...
//   const endpoint = import.meta.env.VITE_API_URL;
  ...
  const handleFetchAndAddNote = async (type) => {
    ...
    if (type === "Study Guide") contentEndpoint = "http://localhost:8000/study-guide";
    else if (type === "Briefing Doc")
      contentEndpoint = "http://localhost:8000/briefing-doc";
    else if (type === "FAQ") contentEndpoint = "http://localhost:8000/faq";
    else return;

    const titleEndpoint = "http://localhost:8000/get-note-title";
    ...
    <div className="card-three">
      <div className="card-container">
        <div className="notes-section">
          <div className="study-material-options">
        <div className="study-material-card" onClick={() => handleFetchAndAddNote("FAQ")}>
          <div className="icon">📚</div>
          <div className="text">FAQs</div>
          <div className="description">Find answers to common questions</div>
        </div>
        <div className="study-material-card" onClick={() => handleFetchAndAddNote("Briefing Doc")}>
          <div className="icon">📑</div>
          <div className="text">Briefs</div>
          <div className="description">Summarized course content</div>
        </div>
        <div className="study-material-card" onClick={() => handleFetchAndAddNote("Study Guide")}>
          <div className="icon">📘</div>
          <div className="text">Study Guides</div>
          <div className="description">In-depth study materials</div>
        </div>
        <div className="study-material-card" onClick={fetchMindmap}>
          <div className="icon">🧠</div>
          <div className="text">Mind Maps</div>
          <div className="description">Visualize complex topics</div>
        </div>
        <div className="study-material-card" onClick={handleAddNote}>
          <div className="icon">📝</div>
          <div className="text">Self-Notes</div>
          <div className="description">Personal notes and reflections</div>
        </div>
